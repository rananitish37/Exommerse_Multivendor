...
import com.codex.ecomerce.services.PaymentService;
...
public class PaymentServiceImpl implements PaymentService {
    ...
    public Boolean proceedPaymentOrder(PaymentOrder paymentOrder, String paymentId, String paymentLinkId) throws RazorpayException {
        if(paymentOrder.getStatus().equals(PaymentOrderStatus.PENDING)){
            ...
            String status = payment.get("status");//to get the status of payment
    ...
    public PaymentLink createRazorpayPaymentLink(User user, Long amount, Long orderId) throws RazorpayException {
        amount = amount*100; //in razor pay we follow amount in "paisa" not "rupees"
        ...
        try {
            ...
            paymentLinkRequest.put("callback_url",
                    "http://localhost:3000/payment-success"+orderId);//frontend url
                        ...
                        setPriceData(SessionCreateParams.LineItem.PriceData.builder()
                                ...
                                .setProductData(
                                        SessionCreateParams
                                                ...
                                                .builder().setName("codex mart payment")
                                                .build()
                                ).build()
                                ).build()
                ).build();
